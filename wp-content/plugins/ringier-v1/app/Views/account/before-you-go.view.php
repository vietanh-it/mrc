...
function html_detail($k = 0,$guest = ''){
    $Location = \RVN\Models\Location::init();
    $country_list = $Location->getCountryList();
    $objBooking = \RVN\Models\Booking::init();
    $list_service_addon = $objBooking->getServiceAddonByBookingId($_GET['id']);
    $list_room = $objBooking->getRoomByBookingId($_GET['id']);
    ?>
    <div class="be-travel">
