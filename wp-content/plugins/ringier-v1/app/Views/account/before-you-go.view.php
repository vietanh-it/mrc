                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div  class="form-account">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="last_name" value="<?php echo !empty($user->user_firstname) ? $user->user_firstname : '' ?>" id="last_name" class="form-control" >
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        <label for="middle_name">Middle name</label>
                                        <input type="text" name="middle_name" value="<?php echo !empty($user->user_firstname) ? $user->user_firstname : '' ?>" id="middle_name" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group" style="position: relative">
                                        <label for="nickname">Nickname</label>
                                        <input type="text" name="nickname" value="<?php echo !empty($user_info->nickname) ? ($user_info->nickname ) : '' ?>" id="nickname" class="form-control " readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    right: 10px;">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group"  style="position: relative">
                                        ...
                                        <input type="text" name="expiration_date" value="<?php echo !empty($user_info->expiration_date) ? date('d M Y', strtotime($user_info->expiration_date)) : '' ?>" id="expiration_date" class="form-control datepicker" readonly>
                                        <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="country_of_birth" id="country_of_birth" class="form-control">
                                    ...
                                    <?php if(!empty($country_list)){
                                        foreach ($country_list as $c){
                                            ?>
                                            <option value="<?php echo $c->alpha_2 ?>" <?php echo (!empty($user_info->country_of_birth) && $user_info->country_of_birth == $c->alpha_2) ? 'selected' : '' ?>><?php echo $c->name ?></option>
                                        <?php }
                                    } ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="issued_in" id="issued_in" class="form-control">
                                    ...
                                    <?php if(!empty($country_list)){
                                        foreach ($country_list as $c){
                                            ?>
                                            <option value="<?php echo $c->alpha_2 ?>" <?php echo (!empty($user_info->country_of_birth) && $user_info->issued_in == $c->alpha_2) ? 'selected' : '' ?>><?php echo $c->name ?></option>
                                        <?php }
                                    } ?>
                                </select>
                            </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="is_visa" id="is_visa" class="form-control">
                                            <option value="no" <?php echo (!empty($user_info->is_visa) && $user_info->is_visa =='no')  ? 'selected': '' ?>>No</option>
                                            <option value="yes" <?php echo (!empty($user_info->is_visa) && $user_info->is_visa =='yes')  ? 'selected': '' ?>>Yes</option>
                                            <option value="not_yes" <?php echo (!empty($user_info->is_visa) && $user_info->is_visa =='not_yes')  ? 'selected': '' ?>>Not yes</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="travel_insurance" id="travel_insurance" class="form-control">
                                            <option value="no" <?php echo (!empty($user_info->travel_insurance) && $user_info->travel_insurance =='no')  ? 'selected': '' ?>>No</option>
                                            <option value="yes" <?php echo (!empty($user_info->travel_insurance) && $user_info->travel_insurance =='yes')  ? 'selected': '' ?>>Yes</option>
                                            <option value="not_yes" <?php echo (!empty($user_info->travel_insurance) && $user_info->travel_insurance =='not_yes')  ? 'selected': '' ?>>Not yes</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div  class="form-account">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="special_assistance" id="special_assistance" class="form-control" >
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div  class="form-account">
                            ...
                            <div class="form-group" style="position: relative">
                                ...
                                <input type="text" name="embarkation_date" value="<?php echo !empty($user_info->embarkation_date) ? date('d M Y', strtotime($user_info->embarkation_date) ) : '' ?>" id="embarkation_date" class="form-control datepicker" readonly>
                                <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="last_inbound_flight_no" id="last_inbound_flight_no" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="last_inbound_originating_airport">Last inbound originating airport</label>
                                <input type="text" name="last_inbound_originating_airport" id="last_inbound_originating_airport" class="form-control" >
                            </div>
                            <div class="form-group" style="position: relative">
                                <label for="last_inbound_date">Last inbound date</label>
                                <input type="text" name="last_inbound_date" value="<?php echo !empty($user_info->last_inbound_date) ? date('d M Y', strtotime($user_info->last_inbound_date) ) : '' ?>" id="last_inbound_date" class="form-control datepicker" readonly>
                                <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="last_inbound_arrival_time" id="last_inbound_arrival_time" class="form-control">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div  class="form-account">
                            ...
                            <div class="form-group" style="position: relative">
                                ...
                                <input type="text" name="debarkation_date" value="<?php echo !empty($user_info->debarkation_date) ? date('d M Y', strtotime($user_info->debarkation_date) ) : '' ?>" id="debarkation_date" class="form-control datepicker" readonly>
                                <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="first_outbound_flight_no" id="first_outbound_flight_no" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="first_outbound_destination_airport">First outbound destination airport</label>
                                <input type="text" name="first_outbound_destination_airport" id="first_outbound_destination_airport" class="form-control" >
                            </div>
                            <div class="form-group" style="position: relative">
                                <label for="first_outbound_date">First outbound date</label>
                                <input type="text" name="first_outbound_date" value="<?php echo !empty($user_info->first_outbound_date) ? date('d M Y', strtotime($user_info->first_outbound_date) ) : '' ?>" id="first_outbound_date" class="form-control datepicker" readonly>
                                <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="first_outbound_departure_time" id="first_outbound_departure_time" class="form-control">
                                    <option value=""> --- Select time --- </option>
                                    <option value=""> time </option>
                                </select>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div  class="form-account">
                            ...
                            <div class="form-group" style="padding-bottom: 12px">
                                ...
                                <a href="javascript:void(0)" class="be-bnt-action" ><img src="<?php echo VIEW_URL.'/images/tru.png'?>" style="padding-right: 10px"></a>
                                <input type="text" value="1" class="be-input-number">
                                <a href="javascript:void(0)" class="be-bnt-action" ><img src="<?php echo VIEW_URL.'/images/cong.png'?>" style="padding-left: 10px"></a> <span style="padding-left: 10px">Night(s)</span>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group" style="position: relative">
                                        ...
                                        <input type="text" name="service_addon_from" value="<?php echo !empty($user_info->service_addon_from) ? date('d M Y', strtotime($user_info->service_addon_from) ) : '' ?>" id="service_addon_from" class="form-control datepicker" readonly>
                                        <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group" style="position: relative">
                                        ...
                                        <input type="text" name="service_addon_to" value="<?php echo !empty($user_info->service_addon_to) ? date('d M Y', strtotime($user_info->service_addon_to) ) : '' ?>" id="service_addon_to" class="form-control datepicker" readonly>
                                        <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                                    </div>
