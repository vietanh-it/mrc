...
<?php if (!empty($list_offer['data'])) { ?>
    <div class="offer-home">
        <div class="container ">
            <div class="row">
                <h2 class="col-xs-12 col-sm-12 tile-main"><a href="<?php echo WP_SITEURL . '/offers/' ?>">Latest
                        offer</a>
                    <br> <img src="<?php echo VIEW_URL . '/images/line.png' ?>">
                </h2>
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <div class="box-journey box-white">
                                ...
                                <div class="desc">
                                    ...
                                    <p><b>Start Date:</b> <?php echo date("j F Y", strtotime($v->start_date)); ?> <a
                                            href="<?php echo $v->permalink ?>" class="read-more" title="read more"><i
                                                class="fa fa-angle-right" aria-hidden="true"></i></a></p>
                                </div>
                                <div class="price">
                                    $<?php echo number_format($v->journey_info->min_price_offer) ?></div>
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="box-why">
                    ...
                    <div class="desc">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dapibus scelerisque ipsum eget
                            mollis. Duis pulvinar nibh ornare.</p>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
