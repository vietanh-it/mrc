                    ...
                    <div class="booking-info">
                        <form>
                            <div class="bk-box " style="padding: 20px 30px">
                                <span style="text-transform: uppercase;font-weight: bold">Stateroom Prices</span> (per person, including any discount)
                            </div>
                            <div class="bk-box bk-box-gray">
                                <span class="text">Main Deck Twin Share</span>  <span class="price"><span class="big">US$2,750</span> <br> US$3,250</span>
                            </div>

                            <div class="bk-box ">
                                <span class="text">Main Deck Twin Single Use</span>  <span class="price"><span class="big">US$2,750</span> <br> US$3,250</span>
                            </div>

                            <div class="bk-box bk-box-gray">
                                <span class="text">Upper Deck Twin Share</span>  <span class="price"><span class="big">US$2,750</span> <br> US$3,250</span>
                            </div>

                            <div class="bk-box ">
                                <span class="text">Upper Deck Twin Single Us</span>  <span class="price"><span class="big">US$2,750</span> <br> US$3,250</span>
                            </div>


                            <div class="bk-box bk-box-2" style="background: #d5b76e;margin-top: 50px">
                                <span style="text-transform: uppercase;font-weight: bold">Your stateroom selection</span>  <span class="price-2">Total: <b>US$8,250</b></span>
                            </div>
