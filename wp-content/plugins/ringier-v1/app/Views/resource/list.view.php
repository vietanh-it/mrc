...
get_header();
$list_post = !empty($list_post) ? $list_post : [];
$list_rs_people = !empty($list_rs_people) ? $list_rs_people : [];
$list_rs_services = !empty($list_rs_services) ? $list_rs_services : [];
$list_rs_food = !empty($list_rs_food) ? $list_rs_food : [];
