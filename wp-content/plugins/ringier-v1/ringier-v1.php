...
if ( !defined('CACHEGROUP') ) define('CACHEGROUP', 'default');
if ( !defined('CACHETIME') ) define('CACHETIME', '3600');

//if ( !defined('SENDY_LIST') ) define("SENDY_LIST", 'OSoGqkr5RWlOmKS892JEXDYQ');

if ( !defined('AVATAR_DEFAULT') ) define('AVATAR_DEFAULT', get_template_directory_uri() . "/images/default_avatar.jpg");
if ( !defined('PASSWORD_DEFAULT') ) define('PASSWORD_DEFAULT', 'marry.vn');
