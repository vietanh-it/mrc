                ...
                <ul class="social-icon">
                    <li>
                        <a href="#" title="" target="_blank" rel="nofollow"><img
                                src="<?php echo THEME_URL . '/images/icon-twiter.png' ?>" alt=""></a>
                    </li>

                    <li>
                        <a href="#" title="" target="_blank" rel="nofollow"><img
                                src="<?php echo THEME_URL . '/images/icon-prin.png' ?>" alt=""></a>
                    </li>

                    <li>
                        <a href="#" title="" target="_blank" rel="nofollow"><img
                                src="<?php echo THEME_URL . '/images/icon-facebook.png' ?>" alt=""></a>
                    </li>

                    <li>
                        <a href="#" title="" target="_blank" rel="nofollow"><img
                                src="<?php echo THEME_URL . '/images/icon-youtube.png' ?>" alt=""></a>
                    </li>

                    <li>
                        <a href="#" title="" target="_blank" rel="nofollow"><img
                                src="<?php echo THEME_URL . '/images/icon-insta.png' ?>" alt=""></a>
                    </li>

                    <li>
                        <a href="#" title="" target="_blank" rel="nofollow"><img
                                src="<?php echo THEME_URL . '/images/icon-google.png' ?>" alt=""></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="copy-right">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 text-right"><a href="#" title="">Terms of Use</a>  | <a href="#" title="">Privacy Policy</a> | <a href="#" title="">Site Map</a></div>
            </div>
        </div>
    </div>
</footer>
