                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-group" style="position: relative">
                            ...
                            <input type="text" name="birthday" value="" id="birthday" class="form-control datepicker" readonly>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="passport_id" value="" id="passport_id" class="form-control">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-group" style="position: relative">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-group"  style="position: relative">
                            ...
                            <input type="text" name="date_of_issue" value="" id="date_of_issue" class="form-control datepicker" readonly>
                            <img src="<?php echo VIEW_URL ?>/images/icon-date-2.png" style="position: absolute;
    bottom: 10px;
    right: 10px;">
                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-group" style="position: relative">
                            ...
                            <input type="text" name="a_email" value="" id="a_email" class="form-control">
    ...
    right: 0px;">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-group" style="position: relative">
                            ...
                            <input type="password" name="a_password" value="" id="a_password" class="form-control " >
                            <img src="<?php echo VIEW_URL ?>/images/icon-a-edit.jpg" style="position: absolute;
    bottom: 0px;
    right: 0px;">
                        </div>
